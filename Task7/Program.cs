...
namespace Task7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ////3
            //Car car = new Car("Tesla", 2021, 130, true);
            //Car car1 = new Car("Suzuki", 2011, 80, false);
            //Ship ship = new Ship("Viking Longboat", 2022);
            //Ship ship1 = new Ship("HMS Bounty", 2011);
            //PC pc = new("Apple", 8000);
            //PC pc1 = new("PRESTIGIO SmartBook 141 C7", 3000);
            //OnlineMarket market = new() { Budget = 5000000 };//3500000
            ...
            //Car car = new Car("Tesla", 2021, 130, true);
            //Car car1 = new Car("Suzuki", 2011, 80, false);
            //Car car2 = new Car("BMW", 2018, 300, true);
            //Car car3 = new Car("Mercedes-Benz ", 1975, 90, false);
            //Ship ship = new Ship("Viking Longboat", 2022);
            //Ship ship1 = new Ship("HMS Bounty", 2011);
            //Ship ship2 = new Ship("Diana", 2011);
            //Ship ship3 = new Ship("Diana Frigate", 2016);
            //PC pc = new PC("Apple", 8000);
            //PC pc1 = new PC("PRESTIGIO SmartBook 141 C7", 3000);
            //PC pc2 = new PC("HP", 8000);
            ...
            //Console.WriteLine(BuyItem(ItemList, market));
        }
        ...
        private static int BuyItem(Dictionary<IItem, int> ItemList, OnlineMarket market)
        {
            ...
            {
                count = market.AddItem(item.Key, item.Value, count);
            }
            return count;
        }
